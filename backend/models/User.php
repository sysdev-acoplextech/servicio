...
public $rif_empresa;
 ...
 {
  return [
     [['username', 'email' , 'nacionalidad', 'nombres', 'apellidos', 'cedula' ], 'required'],
     ...
     // ['rif_empresa', 'empresa_registrada' ],
     ['repeatPassword', 'required'],
     ['repeatPassword', 'string', 'min' => 6],
     ['repeatPassword', 'compare', 'compareAttribute'=>'password', 'message'=>"Las contraseñas no coinciden"],
 ];
}
