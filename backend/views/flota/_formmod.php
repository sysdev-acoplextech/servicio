            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        echo $form->field($model, 'condicion_anterior')->hiddenInput(['maxlength' => true, 'value'=> $model->id_condicion])->label(false);
                        ?>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                    <?php 
                    $fecha = explode("-", $model->fecha_vencimiento_rcv);
                    $model->fecha_vencimiento_rcv = $fecha[2] . "-" . $fecha[1] . "-" . $fecha[0];

                    echo $form->field($model, 'fecha_vencimiento_rcv')->widget(DatePicker::classname(), [
                                'options' => ['placeholder' => 'Seleccione...'],
                                'pluginOptions' => [
