...
<div class="modal modal-default fade" id="modal-gestion">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Gestión de Pago</b></h4>
            </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-6  col-xs-12">
                        <?php
                        echo $form->field($model, 'fecha_gestion_pago_desde')->widget(DatePicker::classname(), [
                        ...
                        ])->label('Fecha de la factura o pago desde');
                        ?>
                    </div>
                    <div class="col-sm-6  col-xs-12">
                        <?php
                        echo $form->field($model, 'fecha_gestion_pago_hasta')->widget(DatePicker::classname(), [
                            'options' => ['placeholder' => 'Seleccione'],
                            'pluginOptions' => [
                                'orientation' => 'bottom',
                                'format' => 'dd-mm-yyyy',
                        ...
                        ])->label('Fecha de la factura o pago hasta');
                        ?>
                    </div>
                </div>
            </div>
