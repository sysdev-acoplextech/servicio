...
<div class="servicios-form">
    ...
    <div>
                ...
                <ul class="nav nav-tabs">
                    <li  class="active"><a data-toggle="tab"  id="cliente" onclick="opendiv('cliente')">Cliente</a></li>
                    <li><a data-toggle="tab" style="display: block" id="pasajero" onclick="opendiv('pasajero')">Pasajero</a></li>
                    <li><a data-toggle="tab" style="display: block" id="servicio" onclick="opendiv('servicio')">Servicio(s)</a></li>
                ...
                <div id="servicio_div" style="display:none">
                        ...
                        <tr>
                            <td style="width: 25%; background-color: #ededed;  border-top-left-radius: 10px;
                                ...
                                <div class="col-md-12">
                                    <br>
                                    <fieldset>
                                        <?= $form->field($model, 'km_servicio')->hiddenInput(['style' => 'font-size: 32px;text-align: center;', 'id' => 'km', 'value' => 1])->label('Detalles del Servicio') ?>
                                        ...
                                        <div id="div_destino" style="height: 350px; width: 500px;">
                                            ...
                                            <div id="monto_tarifario" style="display: none;" class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <?= $form->field($model, 'item_km')->textInput(['id' => 'item_km', 'style' => 'text-align: right',  'onchange' => 'cambia_monto(this.value)'])->label(false); ?>
                                                </div>
                                                <hr>
                                            </div>
                                            <div id="vs_maleta" class="col-md-12" style="display: none;">
                                                ...
                                                <div class="col-md-5">
                                                    <?php echo $form->field($model, 'cant_v1')->widget(TouchSpin::classname(), [
                                                        'options' => ['placeholder' => '', 'id' => 'cant_v1', 'value' => 1, 'onchange' => 'suma_cantidad_p(1)'],
                                                        'pluginOptions' => [
                                                            'min' => 0,
                                                            'max' => 30,
                                                            'step' => 1,
                                                ...
                                                <div class="col-md-3">
                                                    <?= $form->field($model, 'subtotal_v1')->textInput(['id' => 'subtotal_v1', 'style' => 'text-align: right', 'onchange'=>'suma_precio(this.value,"monto_v1")'])->label(false); ?>
                                                    <?= $form->field($model, 'monto_v1')->hiddenInput(['id' => 'monto_v1', 'style' => 'text-align: right'])->label(false); ?>
                                                </div>
                                                <div class="col-md-2">
                                                    <img src="../web/img/minus.png" alt="menos" width="70%" onclick="quitar_p(1)">
                                                </div>
                                            </div>
                                            ...
                                            <div id="vs_pax" class="col-md-12" style="display: none;">
                                                ...
                                                <div class="col-md-5">
                                                    <?php echo $form->field($model, 'cant_v2')->widget(TouchSpin::classname(), [
                                                        'options' => ['placeholder' => '', 'id' => 'cant_v2', 'value' => 1, 'onchange' => 'suma_cantidad_p(2)'],
                                                        'pluginOptions' => [
                                                            'min' => 0,
                                                            'max' => 30,
                                                            'step' => 1,
                                                ...
                                                <div class="col-md-3">
                                                    <?= $form->field($model, 'subtotal_v2')->textInput(['id' => 'subtotal_v2', 'style' => 'text-align: right', 'onchange'=>'suma_precio(this.value,"monto_v2")'])->label(false); ?>
                                                    <?= $form->field($model, 'monto_v2')->hiddenInput(['id' => 'monto_v2', 'style' => 'text-align: right'])->label(false); ?>
                                                </div>
                                                <div class="col-md-2">
                                                    <img src="../web/img/minus.png" alt="menos" width="70%" onclick="quitar_p(2)">
                                                </div>
                                            </div>
                                            ...
                                            <div id="vs_silla" class="col-md-12" style="display: none;">
                                                ...
                                                <div class="col-md-5">
                                                    <?php echo $form->field($model, 'cant_v5')->widget(TouchSpin::classname(), [
                                                        'options' => ['placeholder' => '', 'id' => 'cant_v5', 'value' => 1, 'onchange' => 'suma_cantidad_p(5)'],
                                                        'pluginOptions' => [
                                                            'min' => 0,
                                                            'max' => 30,
                                                            'step' => 1,
                                                ...
                                                <div class="col-md-3">
                                                    <?= $form->field($model, 'subtotal_v5')->textInput(['id' => 'subtotal_v5', 'style' => 'text-align: right', 'onchange'=>'suma_precio(this.value,"monto_v5")'])->label(false); ?>
                                                    <?= $form->field($model, 'monto_v5')->hiddenInput(['id' => 'monto_v5', 'style' => 'text-align: right'])->label(false); ?>
                                                </div>
                                                <div class="col-md-2">
                                                    <img src="../web/img/minus.png" alt="menos" width="70%" onclick="quitar_p(5)">
                                                </div>
                                            ...
                                            <div id="vs_mascota" class="col-md-12" style="display: none;">
                                                ...
                                                <div class="col-md-5">
                                                    <?php echo $form->field($model, 'cant_v7')->widget(TouchSpin::classname(), [
                                                        'options' => ['placeholder' => '', 'id' => 'cant_v7', 'value' => 1, 'onchange' => 'suma_cantidad_p(7)'],
                                                        'pluginOptions' => [
                                                            'min' => 0,
                                                            'max' => 30,
                                                            'step' => 1,
                                                ...
                                                <div class="col-md-3">
                                                    <?= $form->field($model, 'subtotal_v7')->textInput(['id' => 'subtotal_v7', 'style' => 'text-align: right', 'onchange'=>'suma_precio(this.value,"monto_v7")'])->label(false); ?>
                                                    <?= $form->field($model, 'monto_v7')->hiddenInput(['id' => 'monto_v7', 'style' => 'text-align: right'])->label(false); ?>
                                                </div>
                                                <div class="col-md-2">
                                                    <img src="../web/img/minus.png" alt="menos" width="70%" onclick="quitar_p(7)">
                                                </div>
                                            ...
                                            <div id="vs_hora_espera" class="col-md-12" style="display: none;">
                                                ...
                                                <div class="col-md-5">
                                                    <?php echo $form->field($model, 'cant_v3')->widget(TouchSpin::classname(), [
                                                        'options' => ['placeholder' => '', 'id' => 'cant_v3', 'value' => 1, 'onchange' => 'suma_cantidad_p(3)'],
                                                        'pluginOptions' => [
                                                            'min' => 0,
                                                            'max' => 30,
                                                            'step' => 1,
                                                ...
                                                <div class="col-md-3">
                                                    <?= $form->field($model, 'subtotal_v3')->textInput(['id' => 'subtotal_v3', 'style' => 'text-align: right', 'onchange'=>'suma_precio(this.value,"monto_v3")'])->label(false); ?>
                                                    <?= $form->field($model, 'monto_v3')->hiddenInput(['id' => 'monto_v3', 'style' => 'text-align: right'])->label(false); ?>
                                                </div>
                                                <div class="col-md-2">
                                                    <img src="../web/img/minus.png" alt="menos" width="70%" onclick="quitar_p(3)">
                                                </div>
                                            ...
                                            <div id="vs_aeropuerto" class="col-md-12" style="display: none;">
                                                ...
                                                <div class="col-md-5">
                                                    <?php echo $form->field($model, 'cant_v4')->widget(TouchSpin::classname(), [
                                                        'options' => ['placeholder' => '', 'id' => 'cant_v4', 'value' => 1, 'onchange' => 'suma_cantidad_p(4)'],
                                                        'pluginOptions' => [
                                                            'min' => 0,
                                                            'max' => 30,
                                                            'step' => 1,
                                                ...
                                                <div class="col-md-3">
                                                    <?= $form->field($model, 'subtotal_v4')->textInput(['id' => 'subtotal_v4', 'style' => 'text-align: right', 'onchange'=>'suma_precio(this.value,"monto_v4")'])->label(false); ?>
                                            ...
                                            <div id="vs_encomienda" class="col-md-12" style="display: none;">
                                                ...
                                                <div class="col-md-5">
                                                    <?php echo $form->field($model, 'cant_v6')->widget(TouchSpin::classname(), [
                                                        'options' => ['placeholder' => '', 'id' => 'cant_v6', 'value' => 1, 'onchange' => 'suma_cantidad_p(6)'],
                                                        'pluginOptions' => [
                                                            'min' => 0,
                                                            'max' => 30,
                                                            'step' => 1,
                                                ...
                                                <div class="col-md-3">
                                                    <?= $form->field($model, 'subtotal_v6')->textInput(['id' => 'subtotal_v6', 'style' => 'text-align: right', 'onchange'=>'suma_precio(this.value,"monto_v6")'])->label(false); ?>
                                                    <?= $form->field($model, 'monto_v6')->hiddenInput(['id' => 'monto_v6', 'style' => 'text-align: right'])->label(false); ?>
                                                </div>
                                                <div class="col-md-2">
                                                    <img src="../web/img/minus.png" alt="menos" width="70%" onclick="quitar_p(6)">
                                                </div>
                                ...
                                <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                <a href="#" class="boton-imagen " id="autobus">
                                                    <img src="../web/img/autobus.png" alt="Autobus" width="100%" onclick="add_categoria_p('Autobus','tipo_vehiculo')">
                                                    <p style="text-align: center;">Autobus</p>
                                                </a>
                                            </div>
                                            <div class="col-md-3">
                                                <a href="#" class="boton-imagen " id="van">
                                                    <img src="../web/img/van.png" alt="Van" width="100%" onclick="add_categoria_p('Van','tipo_vehiculo')">
                                                    <p style="text-align: center;">Van</p>
                                                </a>
                                            </div>
                                            <div class="col-md-3">
                                                <a href="#" class="boton-imagen " id="camioneta">
                                                    <img src="../web/img/camioneta.png" alt="Camioneta" width="100%" onclick="add_categoria_p('Camioneta','tipo_vehiculo')">
                                                    <p style="text-align: center;">Camioneta</p>
                                                </a>
                                            </div>
                                            <div class="col-md-3">
                                                <a href="#" class="boton-imagen " id="sedan">
                                                    <img src="../web/img/sedan.png" alt="Sedan" width="100%" onclick="add_categoria_p('Sedán','tipo_vehiculo')">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="col-md-12" style="text-align: center;">
                                            <div class="col-md-3">
                                                <button type="button" class="btn btn-success" style="width: 100%;" onclick="add_categoria_p('Nacional','ruta')">Nacional</button>
                                            </div>
                                            <div class="col-md-3">
                                                <button type="button" class="btn btn-success" style="width: 100%;" onclick="add_categoria_p('Gran Caracas','ruta')">Gran Caracas</button>
                                            </div>
                                            <div class="col-md-3">
                                                <button type="button" class="btn btn-primary" style="width: 100%;" onclick="add_categoria_p('Diurno','horario')">Diurno</button>
                                            </div>
                                            <div class="col-md-3">
                                                <button type="button" class="btn btn-primary" style="width: 100%;" onclick="add_categoria_p('Nocturno','horario')">Nocturno</button>
                                            </div>
                                        </div>
                ...
                <div id="cliente_div" style="display:block">
