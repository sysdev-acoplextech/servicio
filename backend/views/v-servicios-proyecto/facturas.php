            ...
            <div class="box-body">
                ...
                <?= GridView::widget([
                    ...
                    'rowOptions' => function ($model, $index, $widget, $grid) {
                        ...
                        $estatus = $model->pagada; // current date
                        switch ($model->pagada) {
                            case 0:
                                return ['class' => 'danger'];
                                break;
                        ...
                        [
                            ...
                            'buttons' => [
                                ...
                                'update' => function ($url, $model) {
                                    ...
                                    return Html::a('<span class="btn btn-danger glyphicon glyphicon-pencil"></span>', [
                                        'detalle-factura/update',
                                ...
                                'view' => function ($url, $model) {
                                    ...
                                    return Html::a('<span class="btn btn-success glyphicon glyphicon-eye-open"></span>', [
                                        'detalle-factura/view',
                                        'id' =>  $model['id_detallefactura'],
                                    ], $options);
                                },

                                'pagar2' => function ($url, $model) {
                                    $options = [
                                ...
                                'pagar' => function ($url, $model) {
                                    ...
                                    return Html::a('<span class="btn btn-success glyphicon glyphicon-credit-card"></span>', [
                                        'pagar',
                                        'id' =>  $model['id_detallefactura'],
                ...
                <div class="form-group">
                    <div class="box-tools pull-right">
                        <?= Html::a('<span class="glyphicon glyphicon-chevron-left"></span> <b>Regresar</b>', ['v-servicios-proyecto/index', 'id_cliente' => $model->id_cliente], ['class' => 'btn btn-warning btn']) ?>
                    </div>
                </div>
            </div>
        </div>
