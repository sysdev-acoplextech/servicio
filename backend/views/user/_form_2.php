...
<div class="user-form">
    ...
    <div class="box box-primary">
      <div class="box-body">
        ...
        <div class="col-md-6 col-sm-12 col-lg-4">
            <?=
            $form->field($model, 'telefono_oficina')->textInput(['id' => 'telefono_oficina'])->widget(\yii\widgets\MaskedInput::className(), [
                'mask' => '9999-999-9999',
            ]);
            ?>
        </div> 
        <div class="col-md-6 col-sm-12 col-lg-4">
            <?=
            $form->field($model, 'telefono_celular')->textInput(['id' => 'telefono_celular'])->widget(\yii\widgets\MaskedInput::className(), [
                'mask' => '9999-999-9999',
            ]);
            ?> 
        </div>  
